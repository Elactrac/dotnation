        ...
        {selectedAccount && contract && isActive && (
          <>
              ...
              <div className="grid grid-cols-2 gap-2">
                {suggestedAmounts.map((value) => (
                  <button
                    ...
                    className={`px-4 py-3 text-sm font-bold rounded-xl transition-all ${amount === value.toString()
                        ? 'bg-white text-black'
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  step="0.001"
                  min="0.001"
                  className={`w-full px-4 py-4 bg-background-dark border ${error ? 'border-error' : 'border-border focus:border-primary'
            ...
            <motion.button
              ...
              className={`w-full py-4 rounded-sm font-semibold text-lg flex items-center justify-center gap-2 transition-all duration-600 ease-gravity ${isSubmitting || !amount || !!error
