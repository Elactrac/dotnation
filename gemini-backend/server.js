...
/**
 * @route POST /api/verify-recaptcha
 * @group Captcha - Google reCAPTCHA verification
 * @param {string} token.body.required - The reCAPTCHA token from frontend.
...
app.post('/api/verify-recaptcha', async (req, res) => {
  try {
    ...
    if (success) {
      ...
      logger.warn('reCAPTCHA verification failed', { 'error-codes': response.data['error-codes'] });
